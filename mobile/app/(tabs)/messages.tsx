  ...
  return (
    <Screen scroll={false} padded={false}>
      ...
      <FlatList
        ...
        onRefresh={load}
        renderItem={({ item }) => (
          <Pressable style={styles.row} onPress={() => router.push(`/messages/${item.dinnerId}`)}>
...
const styles = StyleSheet.create({
  title: { ...typography.h1, color: colors.text, marginHorizontal: spacing.lg, marginTop: spacing.md, marginBottom: spacing.md },
